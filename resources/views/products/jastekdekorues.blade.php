...
<head>
  ...
  <style>
    ...
    @media (min-width: 768px){ .product-thumb{ aspect-ratio: 4 / 5; } }
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
  <div class="container-fluid justify-content-center">
    ...
    <button class="navbar-toggler ms-auto" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent" aria-label="Toggle navigation">
      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown me-3">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="/jastekdekorues"><i class="bi bi-square me-2"></i>JastekDekorues</a></li>
    ...
    @foreach ($products as $p)
      <div class="col-6 col-md-4 col-lg-3">
        <article class="card product-card h-100">
          ...
          <a class="stretched-link" href="{{ route('products.show', $p->slug) }}" aria-label="Shiko {{ $p->name }}"></a>
        </article>
      </div>
    @endforeach
  </div>
