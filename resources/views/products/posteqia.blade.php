  ...
  <div class="col-6 col-md-4 col-lg-3">
    <div class="card product-card">
      <a href="#" class="open-image-modal" data-bs-toggle="modal" data-bs-target="#imageModal"
         data-image="{{ asset('posteqiaa/' . $file) }}">
        <img src="{{ asset('posteqiaa/' . $file) }}" alt="Tepiha" class="img-fluid">
      </a>
      <div class="card-body">
        <p class="dimensions">Posteqia</p>
      </div>
    </div>
  </div>
@endforeach
