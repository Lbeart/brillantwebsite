  ...
  <div class="col-6 col-md-4 col-lg-3">
    <div class="card product-card">
      <a href="#" class="open-image-modal" data-bs-toggle="modal" data-bs-target="#imageModal"
         data-image="{{ asset('curtainn/' . $file) }}">
        <img src="{{ asset('curtainn/' . $file) }}" alt="Tepiha" class="img-fluid">
      </a>
      <div class="card-body">
        <p class="dimensions">Perde Anesore</p>
      </div>
    </div>
  </div>
@endforeach
