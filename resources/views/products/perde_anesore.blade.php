...
<head>
  <meta charset="UTF-8">
  <title>Perde Anësore – Katalogu</title>
  ...
  <style>
    :root{
      ...
      --brand: #dc3545; /* përdoret për çmime */
    }
    ...
    /* ======= NAVBAR (dark navy – njësoj si te Mbulesa) ======= */
    .navbar-custom{
      position: fixed;
    ...
    /* Empty/Pagination si te Mbulesa */
    .empty{
...
<!-- NAVBAR (navbar-dark si te Mbulesa) -->
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item active" href="/anesore">Perde Anësore</a></li>
...
<header class="page-header">
  <h1>Perde Anësore</h1>
  <div class="page-sub">Modele elegante për çdo ambient – gati për porosi.</div>
</header>
