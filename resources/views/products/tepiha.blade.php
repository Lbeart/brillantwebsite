  ...
  <div class="col-6 col-md-4 col-lg-3">
    <div class="card product-card">
      <a href="#" class="open-image-modal" data-bs-toggle="modal" data-bs-target="#imageModal"
         data-image="{{ asset('carpet/' . $file) }}">
        <img src="{{ asset('carpet/' . $file) }}" alt="Tepiha" class="img-fluid">
      </a>
      <div class="card-body">
        <p class="dimensions">Tepiha</p>
      </div>
    </div>
  </div>
@endforeach
