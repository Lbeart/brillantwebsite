...
<head>
  ...
  <style>
    ...
    .product-thumb{
      ...
      aspect-ratio: 4 / 5; /* foto më elegante */
    }
    @media (max-width: 767.98px){
      .product-thumb{ aspect-ratio: 1 / 1; } /* katrore në mobile */
    }
...
<script>
  // Submenu hover në desktop (opsionale për UX të lehtë)
...
if(data.ok){
  cartBadges.forEach(b => b.textContent = data.totalQty);
}
