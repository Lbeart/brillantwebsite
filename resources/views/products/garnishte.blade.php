...
<head>
  <meta charset="UTF-8">
  <title>Garnishte – Katalogu</title>
  ...
  <style>
    ...
    /* Dropdown (i lehtë mbi navbar-in e errët) */
    .dropdown-menu{
...
<!-- NAVBAR (klasa navbar-dark për toggler ikonën e bardhë) -->
      ...
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="/garnishte"><i class="bi bi-dash-square me-2"></i>Garnishte</a></li>
          </ul>
        </li>
